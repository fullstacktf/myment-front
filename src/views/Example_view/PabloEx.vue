<template>
  <div>
    <h3>USER CARD (for the user profile view)</h3>
    <div class="exampleWrapper">
      <div class="infoSquare">
        <sui-card>
          <div class="cardWrapper">
            <div class="left">
              ...
              <sui-card-meta>
                <span>here should go the rank</span>
              </sui-card-meta>
            </div>
            <span class="mainInfo">
              <sui-card-content>
            ...
            <span class="userForm">
              <sui-card-content>
                ...
                <form action="post">
                  <input type="text" placeholder="location1 (city)" />
                  <input type="text" placeholder="location2 (zone)" />
                  <input type="text" placeholder="should be the tag ader" />
                </form>
              </sui-card-content>
            </span>
          </div>
        ...
        <div class="onlyText">
          <p>- the CSS is from the library, can be custom made</p>
          <hr />
          <p>- easy add as cp cv from documentation</p>
          <hr />
          <p>- simple props modifying, with a explanation table on the docs</p>
          <hr />
        </div>
      </div>
    </div>
